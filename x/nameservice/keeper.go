...
type Keeper struct {
	...
	cdc *code.Codec // The wire codec for binary encoding/decoding.
}
...
// GetOwner - get the current owner of a nem
func (k Keeper) GetOwner(ctx sdk.Context, name string) sdk.AccAddress {
	return k.GetWhois(ctx, name).Owner
}

// SetOwner - set the current owner of a name
...
// IsNamePresent - check if the name is presnet in the store or not
